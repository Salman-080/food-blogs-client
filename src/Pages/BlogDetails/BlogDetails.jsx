...
const BlogDetails = () => {
    ...
    // useEffect(()=>{
    //     axios.get(`http://localhost:5000/details/${id}?email=${user?.email}`)
    //     .then(res=>{
    ...
    useEffect(()=>{
        axios.get(`http://localhost:5000/commentsInfo/${BlogDetails?._id}`)
        .then(res=>{
    ...
    //     queryKey: ['Comments'],
    //     queryFn: async () => {
    //         const res = await axios.get(`http://localhost:5000/commentsInfo/${BlogDetails._id}`);
    ...
    const handleComments = e => {
        ...
        axios.post("http://localhost:5000/commentsInfo", commentsInfo)
            .then(res => {
                console.log(res.data)
